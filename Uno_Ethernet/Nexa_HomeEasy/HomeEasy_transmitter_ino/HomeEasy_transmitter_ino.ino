...
void setup() {
  ...
  homeEasy.registerAdvancedProtocolDimmingHandler(printAdvancedDimmingResult);
...
void printAdvancedDimmingResult(unsigned long sender, unsigned int recipient, bool on, bool group, byte dim) {
  Serial.println("advanced");
...
//  homeEasy.sendSimpleProtocolMessage(sender, recipient, action);
  homeEasy.sendAdvancedProtocolDimmingMessage(sender, recipient, action, false, 8);
